        ...
        <div className="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-white-500">
            ...
            <div className="px-5 pb-5">
                ...
                <div className="flex items-center justify-between">
                    ...
                    >
                        {/* prevent default removes the default behaviour , default behaviour of anchor tag is to perform get Request at a particular url , prevent default avoids that  */}
                        Add to cart
                    </a>
                </div>
            </div>
